  ...
  return (
    <Layout>
        <Header
          ...
          p1 = {"In the fall of 2019, I took a course in “Introduction to Object-Oriented Programming” at Brown University"}
          p2 = {"For one of my assignments, I programmed a game of Doodle Jump in Java. The objective of this assignment was to represent parts of the program like the “doodle” or the platforms both graphically and logically. "}
        />
        <div className={style.margin}>
            ...
            <ImageLoader filename="doodleJump/gameCode.png" className={style.Himage}/>
