...
export default () => {
  return (
    ...
    <Layout>
      <Header
        imageLoader = {< ImageLoader filename="pinPal/introImage.png"/>}
        name  = {"Pinpal"}
        date  = {"November 2019 (8 weeks)"}
        number  = {"Team: 4"}
        role ={"UI design, Illustration, UX research"}
        oneliner  = {"Bringing back memorable experiences through collectable tokens."}
        p1 = {"When you look around the streets, most people have their faces buried in their smartphone screens oblivious to the rich possibilities in their own neighborhood.My teammates and I designed an app to help explore users' personal geography, a way to pin the shops, locales and spots with personal meaning in their community."}
        p2 = {"What if you could knock your screen to pin your location using GPS?"}     
         />
      <div className={style.margin}>
          <div className={style.wrapper}>
            ...
            <ImageLoader filename="pinPal/knocking.png" className={style.HimageS}/>
            ...
            <ImageLoader filename="pinPal/newPop.png" className={style.HimageS}/>
                    <p className={style.paragraph}> 
            ...
            <ImageLoader filename="pinPal/layerColor.png" className={style.HimageS}/>
            ...
            <div className={style.subtitle}> Notification </div>
                <ImageLoader filename="/pinPal/1.png" className={style.HimageXS}/>
                <ImageLoader filename="/pinPal/2.png" className={style.HimageXS}/>
                <ImageLoader filename="/pinPal/3.png" className={style.HimageXS}/>
            <div className={style.subtitle}> Maps </div>
                <ImageLoader filename="/pinPal/Maps.png" className={style.FDImage}/>
                  <video controls autoplay loop className={style.vidXS}>
